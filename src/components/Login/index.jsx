...
const Login = () => {
  return (
    <div className="p-5 bg-primary min-vh-100 justify-content-center align-items-center d-flex">
              ...
              <div className="h-100 w-100">
                <div className="card-body text-center">
                  ...
                  <div className="d-flex flex-column">
                    <Link className="text-decoration-none mb-2" to="#">Forgot Password?</Link>
